...
try:
    ...
    BOT_REAL = False
    logging.warning("BinaryOptionsToolsV2 pa enstale — ap itilize mod demo")
...
POCKET_SSID = os.getenv(
    "POCKET_OPTION_SSID",
    '42["auth", {"sessionToken":"610648e6d940f217a9e05b179aac75ad","uid":"124162892","lang":"en","currentUrl":"cabinet","isChart":1}]'
)
...
async def get_candles_and_decide(pair):
    ...
    try:
        ...
        d = random.choice(["call","put"])
        return d, "M1", f"Ere: {e.__class__.__name__}"
