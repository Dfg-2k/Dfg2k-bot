...
def send_signal_and_trade(chat_id, message_id, pair, signal, confidence, reason):
    ...
    display_time = entry_time.strftime("%I:%M %p").lower()
...
{result_text}
🔘 1  {final_time.strftime("%I:%M %p").lower()}"""
...
def run_bot():
    global last_update_id, auto_signal_active, selected_timeframe
